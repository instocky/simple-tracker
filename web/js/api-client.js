...
class TimeTrackerAPI {
  ...
  async startProject(identifier) {
    try {
      ...
      throw new Error(
        `Ошибка запуска проекта "${identifier}": ${error.message}`
      );
    }
  }
  ...
  async pauseProject(identifier) {
    try {
      ...
      throw new Error(
        `Ошибка приостановки проекта "${identifier}": ${error.message}`
      );
    }
  }
  ...
  async completeProject(identifier) {
    try {
      ...
      throw new Error(
        `Ошибка завершения проекта "${identifier}": ${error.message}`
      );
    }
  }
  ...
  async archiveProject(identifier) {
    try {
      ...
      throw new Error(
        `Ошибка архивации проекта "${identifier}": ${error.message}`
      );
    }
  }
